...
namespace Pleiades::Sandbox
{
	void CamMirrorSkullWorld::DrawWorld()
	{
		...
		m_Wall.Bind(d3dres, m_Effects, m_Camera.get_viewprojection());
	...
	void CamMirrorSkullWorld::DrawSkull()
	{
		...
		m_Skull.Bind(d3dres, m_Effects, m_Camera.get_viewprojection());
	...
	void CamMirrorSkullWorld::DrawMirror(bool stencil)
	{
		...
		m_Mirror.Bind(d3dres, m_Effects, m_Camera.get_viewprojection());
