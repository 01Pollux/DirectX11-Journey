...
{
	class AnimatedTexturedBox : public ISandbox
	{
	public:
		using EffectManager = AnimTextureBox::EffectManager;

		AnimatedTexturedBox(DX::DeviceResources* d3dres);
