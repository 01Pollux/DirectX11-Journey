...
void DeviceResources::CreateWindowSizeDependentResources()
{
	...
	else
	{
		...
		swapChainDesc.SwapEffect = !c_MSAAOn && (m_options & (c_FlipPresent | c_AllowTearing | c_EnableHDR)) ? DXGI_SWAP_EFFECT_FLIP_DISCARD : DXGI_SWAP_EFFECT_DISCARD;
	...
	for (auto listener : m_deviceNotify)
		listener->OnDeviceWindowSizeChanged();
}
